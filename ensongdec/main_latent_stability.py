...
def run_experiment(experiment_metadata, config_filepath):
    ...
    if neural_mode == 'RAW' or neural_mode == 'TX':
        neural_array = data_dict['neural_dict']['original_neural_traces'][neural_key]
        ...
        neural_array = data_dict['neural_dict']['original_neural_traces'][neural_key][latent_mode][neural_key+'_dim'+str(dimensionality)]['trajectories']
