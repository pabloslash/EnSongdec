...
from b1_falcon_utils import get_rasters_audio, extract_threshold_crossings, get_window_traces, detect_tx, bandpass_filter, butter_bandpass
...
def process_sessions(sessions_metadata, save_dir, logger):
    ...
    for day in sessions_metadata:
        ...
        # Select time window around the bout. Hard-coded for now.
        t_pre = 0.1
        ...
        # ! TODO: Implement the option to load from spikesorted data.
