...
def save_dataset(
    ...
    Raises:
        ValueError: If the provided `file_type` is not 'RAW' or 'TRAJECTORIES'.
    ...
    if file_type not in ['RAW', 'TRAJECTORIES']:
        raise ValueError("file_type must be 'RAW' or 'TRAJECTORIES'")
